...
```
    ...
    ==========================================================================================
        ...
        59 |    17700 |     12 |  0.000000E+00 |  0.000000E+00 |  0.000000E+00 |             f
       ...
       122 |    36600 |     12 |  0.000000E+00 |  0.000000E+00 |  0.000000E+00 |             f
       ...
       185 |    55500 |     15 |  0.000000E+00 |  0.000000E+00 |  0.000000E+00 |             f
       ...
       248 |    74400 |     19 |  0.000000E+00 |  0.000000E+00 |  0.0054245770 |             f
...
```
    ...
    [GD] it= 310/400  HV=0.000000  best=3.809836  step=4.66e-12
...
```
    ...
    [step5-prep] Taking 35 from UNION_MECHS
    [step5-prep] Also adding 10 GD-refined designs
    [step5-prep] After sanitize+dedup: 10 candidates
    [step5] sanitized: feasible 10/10 (will send only feasible to scorer)
      idx=  0  d=0.2867  m=6.6017  finite=True  feasible=True
      idx=  1  d=0.4059  m=1.5695  finite=True  feasible=True
      idx=  2  d=0.2869  m=6.4833  finite=True  feasible=True
      idx=  3  d=0.3147  m=1.8106  finite=True  feasible=True
      idx=  4  d=0.2885  m=3.9810  finite=True  feasible=True
    [step5] Scoring 10 candidate(s) for Problem 5
    Saved score for Problem 5:     3.013802
    Candidate (union) score:   3.849667
    Will update: True
    [step5] merged: feasible 18/18 (will send only feasible to scorer)
    [step5] Merged+pruned feasible set: 10 | New score: 3.849667
...
```
    ...
    {'Overall Score': 3.685554737024161, 'Score Breakdown': {'Problem 1': 4.9951039703176825, 'Problem 2': 2.9328630015500465, 'Problem 3': 3.1251822811640793, 'Problem 4': 4.38721630349805, 'Problem 5': 3.8496669817271005, 'Problem 6': 2.823295883888008}}
...
```
    ...
    ✅ Exported
      ...
      Cells:  43
      Note: export reflects on-disk content last saved at 2025-10-02 08:57:43. Save notebook first.
